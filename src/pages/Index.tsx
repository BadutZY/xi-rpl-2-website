    ...
    <div className="min-h-screen">
      ...
      <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
        <div className="container mx-auto px-6 z-10 text-center">
          ...
          >
            <a href="#technologies" className="btn-primary px-8 py-4 rounded-lg font-medium inline-flex items-center justify-center gap-2">
              Jelajahi Pembelajaran
              <ArrowDown size={18} />
            </a>
            <a href="#about" className="btn-secondary-outline px-8 py-4 rounded-lg font-medium text-center">
              Tentang RPL
            </a>
          </motion.div>
        </div>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {[
              {
                title: "Kurikulum",
                desc: "Kurikulum dirancang untuk mengajarkan pemrograman, pengembangan web, manajemen database, dan robotik dengan pendekatan praktis dan proyek berbasis industri.",
              },
              {
                title: "Kegiatan",
                desc: "Siswa terlibat dalam pelatihan intensif untuk mengasah kemampuan coding dan kolaborasi dalam lingkungan profesional.",
              },
            ].map((item, i) => (
              <motion.div
                key={item.title}
            ...
            {[
              {
                ...
                tags: [{ label: "Laravel", cls: "lesson-tag-red" }],
              },
              {
                ...
                tags: [
                  { label: "MySQL", cls: "lesson-tag-blue" },
                  { label: "PhpMyAdmin", cls: "lesson-tag-yellow" },
                ],
              },
              {
                ...
                tags: [{ label: "C++", cls: "lesson-tag-blue" }],
              },
            ].map((item, i) => (
              <motion.div
                key={item.title}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            >
              <div>
                ...
                <h3 className="text-2xl font-bold mb-4 font-heading text-center text-foreground">Data Siswa</h3>
                <p className="text-muted-foreground text-center mb-6">Lihat daftar siswa XI RPL 2</p>
              </div>
              <Link
                to="/students"
            ...
            >
              ...
              <Link
                to="/schedule"
                className="btn-emerald px-6 py-3 rounded-lg font-medium inline-flex items-center gap-2"
              >
                See Schedule
                <ArrowRight size={18} />
              </Link>
