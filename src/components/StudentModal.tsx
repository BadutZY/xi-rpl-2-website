...
import { X, Instagram, Github, Twitter, Youtube, Gamepad2, Linkedin } from "lucide-react";
        ...
        >
          ...
          >
            ...
            <div className="text-center">
              {/* Photo placeholder */}
              <div className="w-28 h-32 mx-auto rounded-xl student-photo-placeholder mb-4 flex items-center justify-center">
